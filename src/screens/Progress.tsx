    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Card>
          ...
          <div className="text-xs font-semibold text-slate-500">✅ {t('progress.workoutsDone')}</div>
        </Card>
        <Card>
          <div className="text-3xl font-extrabold text-amber-500">{streak}</div>
          <div className="text-xs font-semibold text-slate-500">🔥 {t('progress.currentStreak')}</div>
        </Card>
      </div>
