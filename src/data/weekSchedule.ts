...
export const weekSchedule: ScheduleDay[] = [
  {
    ...
    typeLT: "Jėga",
    icon: "💪",
    focus: "Push-ups, Sit-ups, Pull-ups / Rows",
    focusLT: "Atsispaudimai, pilvo presas, prisitraukimai / irklavimas",
    color: "#ef4444",
  },
  {
    day: "Tue",
    ...
    typeLT: "Kardio",
    icon: "🏃",
    focus: "3 km Run / Walk-Run intervals",
    focusLT: "3 km bėgimas / ėjimo-bėgimo intervalai",
    color: "#f97316",
  },
  {
    day: "Wed",
    type: "Core + Mobility",
    typeLT: "Liemuo ir Mobilumas",
    icon: "🧘",
    focus: "Plank, Flutter Kicks, Stretching",
    focusLT: "Lenta, kojų plakimai, tempimas",
    color: "#eab308",
  },
  {
    day: "Thu",
    ...
    typeLT: "Jėga",
    icon: "💪",
    focus: "Squats, Lunges, Burpees",
    focusLT: "Pritūpimai, išpuoliai, burpės",
    color: "#ef4444",
  },
  {
    day: "Fri",
    type: "Cardio + Full Test",
    typeLT: "Kardio ir Pilnas Testas",
    icon: "🏆",
    focus: "Run + Push-up + Sit-up timed test",
    focusLT: "Bėgimas + atsispaudimų ir pilvo preso testas",
    color: "#22c55e",
  },
  {
    day: "Sat",
    type: "Active Recovery",
    typeLT: "Aktyvus Poilsis",
    icon: "🚴",
    focus: "Light walk, cycling or swimming",
    focusLT: "Lengvas pasivaikščiojimas, dviratis ar plaukimas",
    color: "#06b6d4",
  },
  {
    day: "Sun",
    ...
    typeLT: "Poilsis",
    icon: "😴",
    focus: "Full rest or optional stretching",
    focusLT: "Visiškas poilsis arba lengvas tempimas",
    color: "#8b5cf6",
  },
];
