    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 pb-24">
      <div className="sticky top-0 z-10 bg-white shadow-sm dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 px-4 py-3">
        <div className="flex items-center gap-3">
          <button onClick={() => router.back()} className="text-slate-500 dark:text-slate-400">
            ←
          </button>
      ...
      <form onSubmit={handleSubmit} className="px-4 py-6 space-y-6">
            ...
            {LEVELS.map((l) => (
              <button
                ...
                className={`flex-1 rounded-xl py-2 text-xs font-medium transition-colors ${
                  level === l ? "ring-2 ring-purple-500" : "opacity-50"
                }`}
              >
                <LevelBadge level={l} />
              </button>
        ...
        <Field label={t("calisthenics.defaultSets")}>
          <div className="flex items-center gap-4">
            ...
            <span className="text-2xl font-bold text-slate-800 dark:text-slate-100 min-w-[2ch] text-center">
              {sets}
            </span>
            <button
              type="button"
        ...
        <Field label={t("calisthenics.defaultRepsOrSecs")}>
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-2xl font-bold text-slate-800 dark:text-slate-100 min-w-[3ch] text-center">
                {repsOrSecs}
              </span>
              <button
                type="button"
