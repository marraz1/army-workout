...
export const ageGroups: AgeGroup[] = [
  {
    ...
    exercises: [
      ...
      },
      {
        id: "flutter-kicks",
        name: "Flutter Kicks",
        nameLT: "Kojų plakimai",
        sets: "3×30s",
        target: "Core & hip",
        targetLT: "Liemuo ir klubai",
        icon: "🌊",
        setsCount: 3,
        repsTarget: 30,
        restSec: 60,
  ...
  },
  {
    ...
    exercises: [
      ...
      {
        id: "run-3km",
        name: "3 km Run / Walk-Run",
        nameLT: "3 km bėgimas / ėjimas-bėgimas",
        sets: "3×/week",
        setsLT: "3×/sav.",
        target: "≤17:00 min",
        targetLT: "≤17:00 min.",
      ...
      },
      {
        id: "inverted-rows",
        name: "Inverted Rows",
        nameLT: "Irklavimas gulint",
        sets: "3×10",
        target: "Upper back",
        targetLT: "Viršutinė nugara",
        icon: "🏋️",
        setsCount: 3,
        repsTarget: 10,
        restSec: 75,
      ...
      },
      {
        ...
        sets: "3×12/leg",
        setsLT: "3×12/koją",
        target: "Functional lower body",
        targetLT: "Funkcinė apatinė kūno dalis",
        icon: "🦵",
        setsCount: 3,
        repsTarget: 12,
        restSec: 75,
      ...
      },
      {
        ...
        nameLT: "Pečių tempimas",
        sets: "Daily 5 min",
        setsLT: "Kasdien 5 min.",
        target: "Mobility",
        targetLT: "Mobilumas",
        icon: "🧘",
        setsCount: 1,
    ...
    restLT: "75 sek. tarp serijų",
    frequency: "4–5 days/week",
    frequencyLT: "4–5 d./sav.",
  },
  {
    range: "41–50",
    min: 41,
    ...
    exercises: [
      {
        id: "knee-push-ups",
        name: "Knee Push-ups → Full",
        nameLT: "Atsispaudimai nuo kelių → pilni",
        sets: "3×15",
        target: "Progress to full",
        targetLT: "Progresas iki pilnų",
        icon: "💪",
        setsCount: 3,
        repsTarget: 15,
        restSec: 90,
      ...
      },
      {
        id: "wall-sit",
        name: "Wall Sit",
        nameLT: "Sėdėjimas prie sienos",
        sets: "3×30s",
        target: "Knee-safe leg strength",
        targetLT: "Keliams saugi kojų jėga",
        icon: "🧱",
        setsCount: 3,
        repsTarget: 30,
        restSec: 90,
      ...
      {
        id: "band-rows",
        name: "Band / Towel Rows",
        nameLT: "Irklavimas su guma / rankšluosčiu",
        sets: "3×12",
        target: "Back strength",
        targetLT: "Nugaros jėga",
        icon: "🏋️",
        setsCount: 3,
        repsTarget: 12,
        restSec: 90,
      ...
      },
      {
        id: "hip-bridge",
        name: "Hip Bridge",
        nameLT: "Klubų tiltelis",
        sets: "3×15",
        target: "Glutes & lower back",
        targetLT: "Sėdmenys ir juosmuo",
        icon: "🌉",
        setsCount: 3,
        repsTarget: 15,
        restSec: 90,
      ...
      },
      {
        id: "slow-squats",
        name: "Slow Squats",
        nameLT: "Lėti pritūpimai",
        sets: "3×12",
        target: "Controlled form",
        targetLT: "Kontroliuojama forma",
        icon: "🦵",
        setsCount: 3,
        repsTarget: 12,
        restSec: 90,
      ...
      },
      {
        ...
        nameLT: "Viso kūno tempimas",
        sets: "Daily 10 min",
        setsLT: "Kasdien 10 min.",
        target: "Flexibility",
        targetLT: "Lankstumas",
        icon: "🧘",
        setsCount: 1,
