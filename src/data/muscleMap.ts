...
const map: Record<string, MuscleHighlight[]> = {
  ...
  "sit-ups": [{ component: FrontTorso, highlight: ["abs", "obliques"] }],
  "run-3km": [
  ...
  "shoulder-stretch": [{ component: FrontTorso, highlight: ["shoulders", "traps"] }],
  "wall-sit": [{ component: FrontLegs, highlight: ["quads", "hip_flexors"] }],
  "band-rows": [
...
export const ALL_MUSCLES: {
  id: string;
  label: string;
  component: MuscleHighlight["component"];
  highlight: string[];
}[] = [
